...
const languageStrings = {
    'en': {
        'translation': {
            'WELCOME' : "Welcome to New York City Guide!",
            ...
            'ABOUT'   : "New York City is a city on the Atlantic Ocean.  A popular summer beach destination, New York City has a rich history of partying and tall buildings.",
...
const SKILL_NAME = "New York City Guide";
