...
var APP_ID = "amzn1.ask.skill.fb90c248-cd29-4bb7-abc3-473c27930c2a"; // TODO replace with your app ID (OPTIONAL).
...
console.log("First Name:", jsonData[1].firstname);
console.log("Last Name:", jsonData[1].lastname);
console.log("Email:", jsonData[1].email);
console.log("Seat Location:", jsonData[1].seatlocation);

for (i = 0; i < jsonData.length; i++) {
    
    console.log(jsonData[i].firstname);
} 
if(jsonData[0].hasOwnProperty('twitter')){
    console.log("I found twitter");
}
