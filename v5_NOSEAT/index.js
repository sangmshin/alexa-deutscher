...
var APP_ID = 'amzn1.ask.skill.47ecbdd9-9ce7-4bbb-8c1d-aa12af017af1';
...
var descriptionHandlers = Alexa.CreateStateHandler(states.DESCRIPTION, {
    ...
    "TellMeThisIntent": function () {
        ...
        if (this.attributes.lastSearch && isInfoTypeValid(infoType)) {
            ...
            repromptSpeech = "You can ask me - what's " + genderize("his-her", person.gender) + " department, title or give me " + genderize("his-her", person.gender) + " phone number";
            this.attributes.lastSearch.lastSpeech = speechOutput;
            this.handler.state = states.SEARCHMODE;
            this.emit(":ask", speechOutput, repromptSpeech);
        }
...
//    var sentences = ["ask - who is " + getRandomName(data), "say - what is " + getRandomName(data) + "'s " + getRandomInfoType()];
    var sentences = ["ask - who is Dan Kelleher", "ask - who is Val DiFebo", "ask - who is Dan Kelleher", "ask - who is Dan Kelleher", "ask - who is Dan Kelleher", "ask - who is Dan Kelleher", "ask - who is Dan Kelleher", "ask - who is Dan Kelleher"];
//    return "You can " + sentences[getRandom(0, sentences.length - 1)];
    return "You can " + sentences[getRandom(0, sentences.length - 1)];
}

function generateSearchHelpMessage(gender) {
    var sentence = "Sorry, I don't know that. You can ask me - what's " + genderize("his-her", gender) + " department, phone number or give me " + genderize("his-her", gender) + " title";
    return sentence;
}
...
//        var sentence = person.firstName + "'s " + "department is " + person.department + " and " + genderize("his-her", person.gender) + " phone number is " + person.number + " and " + genderize("his-her", person.gender) + " seat location is " + person.seatlocation + " on " + whichFloor(person.seatlocation) + "th floor. " + generateSendingCardToAlexaAppMessage(person, "general");
        var sentence = person.firstName + "'s " + "department is " + person.department + " and " + genderize("his-her", person.gender) + " phone number is " + person.number + ". " + generateSendingCardToAlexaAppMessage(person, "general");
...
function generateSpecificInfoMessage(slots, person) {
    ...
    if ( person.firstName == "dan" ) {
        sentence = person.firstName + "'s " + infoTypeValue + " is - " + person[infoTypeValue] + ". Would you like to find another Deutscher? You can ask - who is Val DiFebo";
    } else if ( person.firstName == "val" ){
        sentence = person.firstName + "'s " + infoTypeValue + " is - " + person[infoTypeValue] + ". Would you like to find another Deutscher? You can ask - who is Dan Kelleher";
    } else {
