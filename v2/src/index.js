...
var APP_ID = 'amzn1.ask.skill.4a5bfcc2-1f59-4a2d-aead-d89aab61035a';
...
var descriptionHandlers = Alexa.CreateStateHandler(states.DESCRIPTION, {
    ...
    "TellMeThisIntent": function () {
        ...
        if (this.attributes.lastSearch && isInfoTypeValid(infoType)) {
            ...
            repromptSpeech = "You can ask me - what's " + genderize("his-her", person.gender) + " department, number, seat location or give me " + genderize("his-her", person.gender) + " title";
            this.attributes.lastSearch.lastSpeech = speechOutput;
            this.handler.state = states.SEARCHMODE;
            this.emit(":ask", speechOutput, repromptSpeech);
        }
...
function generateSearchHelpMessage(gender) {
    var sentence = "Sorry, I don't know that. You can ask me - what's " + genderize("his-her", gender) + " department, number, seat location or give me " + genderize("his-her", gender) + " title";
    return sentence;
}
...
function generateSpecificInfoMessage(slots, person) {
    ...
    if (slots.infoType.value == "position") {
        infoTypeValue = "title";
        console.log("resetting position to title");
    } else {
        console.log("no reset required for title");
